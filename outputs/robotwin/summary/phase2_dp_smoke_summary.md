...
| expert 数据 | `../RoboTwin-Project/RoboTwin/data/grab_roller/demo_clean_smoke` | 5 个 HDF5、5 个 expert videos、instructions、seed.txt |
| DP zarr | `../RoboTwin-Project/RoboTwin/policy/DP/data/grab_roller-demo_clean_smoke-5.zarr` | `head_camera/state/action = 6289` steps |
| DP checkpoint | `../RoboTwin-Project/RoboTwin/policy/DP/checkpoints/grab_roller-demo_clean_smoke-5-0/2.ckpt` | debug training checkpoint，约 1.1GB |
| DP training log | `../RoboTwin-Project/RoboTwin/policy/DP/data/outputs/grab_roller_dp_smoke_seed0/logs.json.txt` | 2 个 debug epoch，train/val loss 正常记录 |
| 官方 eval 启动 | `../RoboTwin-Project/RoboTwin/eval_result/grab_roller/DP/demo_clean_smoke/demo_clean_smoke/2026-05-29 10:40:40/episode0.mp4` | 90s timeout 前已启动并写出视频 |
